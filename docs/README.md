...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-17 21:43:19 UTC<br>状态：成功</p>
</section>
...
<p>今日精读 1 篇、速读 5 篇，重点锁定云安全从 Hypervisor 到容器的漏洞与防御全景。最值得看的是获 8.0 分的云安全综述，以及 CHERI 恒定时间策略下可证明安全推测（7.0）和边缘自适应安全治理（7.0）两个方向。普通读者可先读云安全综述建立整体认知，再按兴趣跟进 CHERI 与边缘安全两篇。</p>
  </div>
</section>
<section class="dpr-home-dashboard-card dpr-home-deep-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="From Hypervisor to Container: Cloud Security Vulnerabilities, Defense Mechanisms, and Open Challenges">From Hypervisor to Container: Cloud Security Vulnerabilities, Defense Mechanisms, and Open Challenges</span></li></ul>
  </div>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="SCHERI: Provably Secure Speculation Under the Constant-Time Policy for CHERI (Extended Version)">SCHERI: Provably Secure Speculation Under the Constant-Time Policy for CHERI (Extended Version)</span></li><li><span class="dpr-home-dashboard-paper-title" title="Autonomy in Check: Governor-Mediated Adaptive Security at the Edge">Autonomy in Check: Governor-Mediated Adaptive Security at the Edge</span></li><li><span class="dpr-home-dashboard-paper-title" title="Adversarial Testing of Automated Program Repair Agents for Security Vulnerabilities">Adversarial Testing of Automated Program Repair Agents for Security Vulnerabilities</span></li></ul>
  </div>
