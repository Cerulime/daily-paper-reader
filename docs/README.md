...
<section class="dpr-home-dashboard-card dpr-home-report-card">
  ...
  <p class="dpr-home-dashboard-body">最近更新：2026-09-16 22:21:24 UTC<br>状态：成功</p>
</section>
...
<p>今日速读两篇论文，聚焦大语言模型与代码安全的前沿交叉。最值得关注的是用LLM自动识别JavaScript漏洞（7.0分），以及将访问控制建模为可验证解析约束的新思路（6.0分）。建议普通读者优先了解LLM在代码漏洞发现中的实际表现与边界。</p>
  </div>
</section>
...
<section class="dpr-home-dashboard-card dpr-home-skim-card">
  ...
  <div class="dpr-home-dashboard-body">
<ul class="dpr-home-dashboard-paper-list"><li><span class="dpr-home-dashboard-paper-title" title="Exploring Automated Vulnerability Identification in JavaScript Code Using Large Language Models">Exploring Automated Vulnerability Identification in JavaScript Code Using Large Language Models</span></li><li><span class="dpr-home-dashboard-paper-title" title="Access Control as Verified Parse Constraints">Access Control as Verified Parse Constraints</span></li></ul>
  </div>
